...
class plc6:
	...
	def __init__(self,HMI):
		...
		# print ("	PLC6 Started\n")
		self.hmi_lit101_ahh = 1


	def Pre_Main_Product(self,IO,HMI,plc):
...
#Main
		...
		if HMI.P6.State == 1:
			...
			try:
				self.hmi_lit101_ahh = int(self.PLC.receive(('HMI_LIT101_AHH',1),PLC1_ADDR))
			except:
				print("Did not receive HMI_LIT101_AHH value")
				pass
			...
			self.Mid_P_PERMEATE_SR = SETD(HMI.LSH601.Alarm and HMI.AIT202.Pv >= 7 and not self.hmi_lit101_ahh and 0 ,self.hmi_lit101_ahh or HMI.LSL601.Alarm or HMI.AIT202.Pv < 7,self.Mid_P_PERMEATE_SR)
...
#Product
		...
		plc.logdf.loc['P6.P601.DO_Start','Value'] = IO.P601.DO_Start
		self.P602.PMP_FBD(self.Mid_P602_AutoInp, IO.P602,HMI.P602)
		plc.logdf.loc['P6.P602.DO_Start','Value'] = IO.P602.DO_Start
