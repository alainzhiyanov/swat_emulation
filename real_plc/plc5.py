...
class plc5:
	...
	def Pre_Main_High_Pressure_RO(self,IO,HMI,Sec_P,Min_P,plc):
...
#	def High_Pressure_RO(self):
		...
		plc.logdf.loc['P5.MV501.DO_Open','Value'] = IO.MV501.DO_Open
		plc.logdf.loc['P5.MV501.DO_Close','Value'] = IO.MV501.DO_Close
		self.MV502_FB.MV_FBD(self.Mid_MV502_AutoInp,IO.MV502,HMI.MV502)
		plc.logdf.loc['P5.MV502.DO_Open','Value'] = IO.MV502.DO_Open
		plc.logdf.loc['P5.MV502.DO_Close','Value'] = IO.MV502.DO_Close
		self.MV503_FB.MV_FBD(self.Mid_MV503_AutoInp,IO.MV503,HMI.MV503)
		plc.logdf.loc['P5.MV503.DO_Open','Value'] = IO.MV503.DO_Open
		plc.logdf.loc['P5.MV503.DO_Close','Value'] = IO.MV503.DO_Close
		self.MV504_FB.MV_FBD(self.Mid_MV504_AutoInp,IO.MV504,HMI.MV504)
		plc.logdf.loc['P5.MV504.DO_Open','Value'] = IO.MV504.DO_Open
		plc.logdf.loc['P5.MV504.DO_Close','Value'] = IO.MV504.DO_Close
		...
		plc.logdf.loc['P5.P501_VSD_Out.Start','Value'] = IO.P501_VSD_Out.Start
		plc.logdf.loc['P5.P501_VSD_Out.Stop','Value'] = IO.P501_VSD_Out.Stop
		...
		plc.logdf.loc['P5.P502_VSD_Out.Start','Value'] = IO.P502_VSD_Out.Start
		plc.logdf.loc['P5.P502_VSD_Out.Stop','Value'] = IO.P502_VSD_Out.Stop
