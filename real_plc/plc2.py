...
class plc2:
	...
	def Pre_Main_UF_Feed_Dosing(self,IO,HMI,plc):
		...
		hmi_p2_permissive_on = int(HMI.MV201.Avl and (HMI.P201.Avl or HMI.P202.Avl) and (HMI.P203.Avl or HMI.P204.Avl) and (HMI.P205.Avl or HMI.P206.Avl))
		# if hmi_p2_permissive_on_val:
		# 	hmi_p2_permissive_on = 1
		# else:
		# 	hmi_p2_permissive_on = 0
		HMI.P2.Permissive_On = hmi_p2_permissive_on
		plc.logdf.loc['HMI_P2_PERMISSIVE_ON','Value'] = hmi_p2_permissive_on
		plc.send(('HMI_P2_PERMISSIVE_ON',2),hmi_p2_permissive_on,PLCX_ADDR)
		...
		plc.logdf.loc['HMI_MV201_STATUS','Value'] = HMI.MV201.Status
		plc.send(('HMI_MV201_STATUS',2),HMI.MV201.Status,PLCX_ADDR)
		plc.logdf.loc['P2.MV201.DO_Open','Value'] = IO.MV201.DO_Open
		plc.logdf.loc['P2.MV201.DO_Close','Value'] = IO.MV201.DO_Close
