...
class plc4:
	...
	def __init__(self,HMI):
		...
		# print ("LIT401_FB Initialized")
		self.P_RO_FEED_DUTY_FB = Duty2_FBD()
		# print ("P_RO_FEED_DUTY_FB Initialized")
		self.P401_FB = PMP_FBD(HMI.P401)
		# print ("P401_FB Initialized")
		self.P402_FB = PMP_FBD(HMI.P402)
		# print ("P402_FB Initialized")
		self.AIT401_FB = AIN_FBD(HMI.AIT401)
		# print ("AIT401_FB Initialized")
		self.FIT401_FB = FIT_FBD(HMI.FIT401)
		# print ("FIT401_FB Initialized")
		self.UV401_FB = UV_FBD(HMI.UV401)
		# print ("UV401_FB Initialized")
		self.AIT402_FB = AIN_FBD(HMI.AIT402)
		# print ("AIT402_FB Initialized")
		self.LS401_FB = SWITCH_FBD(HMI.LS401)
		# print ("LS401_FB Initialized")

		self.P_NAHSO3_ORP_DUTY_FB = Duty2_FBD()
		# print ("P_NAHSO3_ORP_DUTY_FB Initialized")
		self.P403_FB = PMP_FBD(HMI.P403)
		# print ("P403_FB Initialized")
		self.P404_FB = PMP_FBD(HMI.P404)
		# print ("P404_FB Initialized")

		# print ("All Phase 4 Function Blocks Initialized Successfully\n")
		# print ("PLC4 Started\n")

	def Pre_Main_RO_Feed_Dosing(self, IO, HMI, plc):
#	def Pre_Condition(self):
		...
		hmi_p4_permissive_on = int((HMI.P401.Avl or HMI.P402.Avl) and (HMI.P403.Avl or HMI.P404.Avl) and HMI.UV401.Avl)
		plc.logdf.loc['HMI_P4_PERMISSIVE_ON','Value'] = hmi_p4_permissive_on
		self.PLC.send(('HMI_P4_PERMISSIVE_ON',2),hmi_p4_permissive_on,PLCX_ADDR)
...
# RO_Feed_Dosing
		...
		plc.logdf.loc['P4.P401.DO_Start','Value'] = IO.P401.DO_Start
		self.P402_FB.PMP_FBD(self.P_RO_FEED_DUTY_FB.Start_Pmp2,IO.P402,HMI.P402)
		plc.logdf.loc['P4.P402.DO_Start','Value'] = IO.P402.DO_Start
