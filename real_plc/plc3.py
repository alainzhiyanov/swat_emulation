...
# there could be CIP in the future, but current SWaT system has none
	def __init__(self,HMI):
		...
		# print ("LIT301_FB Initialized")
		self.P_UF_FEED_DUTY_FB = Duty2_FBD()
		# print ("P_UF_FEED_DUTY_FB Initialized")
		self.P301_FB = PMP_FBD(HMI.P301)
		# print ("P301_FB Initialized")
		self.P302_FB = PMP_FBD(HMI.P302)
		# print ("P302_FB Initialized")
		self.FIT301_FB = FIT_FBD(HMI.FIT301)
		# print ("FIT301_FB Initialized")
		self.PSH301_FB = SWITCH_FBD(HMI.PSH301)
		# print ("PSH301_FB Initialized")
		self.DPSH301_FB = SWITCH_FBD(HMI.DPSH301)
		# print ("DPSH301_FB Initialized")
		self.DPIT301_FB = AIN_FBD(HMI.DPIT301)
		# print ("DPIT301_FB Initialized")
		self.MV301_FB = MV_FBD(HMI.MV301)
		# print ("MV301_FB Initialized")
		self.MV302_FB = MV_FBD(HMI.MV302)
		# print ("MV302_FB Initialized")
		self.MV303_FB = MV_FBD(HMI.MV303)
		# print ("MV303_FB Initialized")
		self.MV304_FB = MV_FBD(HMI.MV304)
		# print ("MV304_FB Initialized")

		# print ("All Phase 3 Function Blocks Initialized Successfully\n")
		# print ("PLC3 Started\n")

	def Pre_Main_UF_Feed(self,IO,HMI,Sec_P,Min_P,plc):
		...
		hmi_p3_permissive_on = int(HMI.MV301.Avl and HMI.MV302.Avl and HMI.MV303.Avl and HMI.MV304.Avl and (HMI.P301.Avl or HMI.P302.Avl))
		plc.logdf.loc['HMI_P3_PERMISSIVE_ON','Value'] = hmi_p3_permissive_on
		plc.send(('HMI_P3_PERMISSIVE_ON',2),hmi_p3_permissive_on,PLCX_ADDR)
...
#	def UF_Feed(self):
		...
		plc.logdf.loc['P3.P301.DO_Start','Value'] = IO.P301.DO_Start
		self.P302_FB.PMP_FBD(self.P_UF_FEED_DUTY_FB.Start_Pmp2, IO.P302, HMI.P302)
		plc.logdf.loc['P3.P302.DO_Start','Value'] = IO.P302.DO_Start
		...
		plc.logdf.loc['P3.MV301.DO_Open','Value'] = IO.MV301.DO_Open
		plc.logdf.loc['P3.MV301.DO_Close','Value'] = IO.MV301.DO_Close
		self.MV302_FB.MV_FBD(self.Mid_MV302_AutoInp, IO.MV302, HMI.MV302)
		plc.logdf.loc['P3.MV302.DO_Open','Value'] = IO.MV302.DO_Open
		plc.logdf.loc['P3.MV302.DO_Close','Value'] = IO.MV302.DO_Close
		self.MV303_FB.MV_FBD(self.Mid_MV303_AutoInp, IO.MV303, HMI.MV303)
		plc.logdf.loc['P3.MV303.DO_Open','Value'] = IO.MV303.DO_Open
		plc.logdf.loc['P3.MV303.DO_Close','Value'] = IO.MV303.DO_Close
		self.MV304_FB.MV_FBD(self.Mid_MV304_AutoInp, IO.MV304, HMI.MV304)
		plc.logdf.loc['P3.MV304.DO_Open','Value'] = IO.MV304.DO_Open
		plc.logdf.loc['P3.MV304.DO_Close','Value'] = IO.MV304.DO_Close
